...
>
	...
	>
		<header
			id="hero_header"
			class="container mx-auto relative z-20"
		>
			<h1
				class="flex flex-col | text-7xl | uppercase w-fit"
			>
				<span class="ml-10 | !font-thin drop-shadow"
					>Passion</span
				>
				<span class="font-title drop-shadow"
					>For Quality</span
				>
			</h1>
		</header>
