...
export const config: VendureConfig = {
  ...
  authOptions: {
    ...
    shopAuthenticationStrategy: [
      ...
      new GoogleAuthenticationStrategy(process.env.GOOGLE_CLIENT_ID as string),
      new FacebookAuthenticationStrategy({
        appId: process.env.FACEBOOK_CLIENT_ID as string,
        appSecret: process.env.FACEBOOK_CLIENT_SECRET as string,
        clientToken: process.env.FACEBOOK_CLIENT_TOKEN as string,
      }),
    ],
    ...
    EmailPlugin.init({
      ...
      globalTemplateVars: {
        ...
        changeEmailAddressUrl:
          "http://localhost:5173/verify-email-address-change",
      },
    }),
    AdminUiPlugin.init({
      route: "admin",
