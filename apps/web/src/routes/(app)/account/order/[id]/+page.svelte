...
<h1 class="my-5 text-center text-2xl font-semibold sm:my-8">
  Order #{order.display_id}
</h1>
<div class="mx-auto grid max-w-screen-lg grid-cols-1 sm:grid-cols-2">
  <div class="col-span-1">
    <h2 class="mb-2 mt-6 text-xl font-semibold text-gray-900">Status</h2>
    {#if order.fulfillment_status === 'shipped'}
      ...
      {#if order.fulfillments[0].tracking_links[0]?.tracking_number}
        <p>
          Tracking # {order.fulfillments[0].tracking_links[0]?.tracking_number}
        </p>
      {/if}
    ...
    <h2 class="mb-2 mt-6 text-xl font-semibold text-gray-900">
      Shipping Address
    </h2>
    <p>
      ...
      <br />
      {#if order.shipping_address.address_2}{order.shipping_address.address_2}
        <br />{/if}
    ...
    <h2 class="mb-2 mt-6 text-xl font-semibold text-gray-900">Payment</h2>
  ...
  <div class="col-span-1">
    <h2 class="mb-2 mt-6 text-xl font-semibold text-gray-900">Items</h2>
