...
export type GetOurFavoritesCollectionQuery = { __typename?: 'Query', collection?: { __typename?: 'Collection', name: string, slug: string, productVariants: { __typename?: 'ProductVariantList', items: Array<{ __typename?: 'ProductVariant', id: string, name: string, price: number, priceWithTax: number, customFields?: { __typename?: 'ProductVariantCustomFields', markDefault?: boolean | null } | null, product: { __typename?: 'Product', name: string, slug: string, id: string, facetValues: Array<{ __typename?: 'FacetValue', name: string, code: string, facet: { __typename?: 'Facet', name: string } }> }, facetValues: Array<{ __typename?: 'FacetValue', name: string, code: string, facet: { __typename?: 'Facet', name: string } }>, assets: Array<{ __typename?: 'Asset', source: string }> }> } } | null };
